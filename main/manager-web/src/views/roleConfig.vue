                  ...
                  <div class="form-column">
                    ...
                    <el-form-item :label="$t('roleConfig.roleIntroduction') + '：'">
                      <el-input
                        ...
                        rows="9"
                        resize="none"
                        :placeholder="form.agentType === 'promptx' ? $t('roleConfig.autoGeneratedPrompt') : $t('roleConfig.pleaseEnterContent')"
...
export default {
  ...
  methods: {
    ...
    async handlePromptXRoleChange(roleData) {
      console.log('handlePromptXRoleChange called with:', roleData);
      ...
      try {
        ...
        Api.promptx.generateSystemPrompt(request, ({ data, err }) => {
          ...
          console.log('generateSystemPrompt response:', { data: body, err });

          if (err || !body || body.code !== 0) {
            this.$message.error({
              message: err?.message || body?.msg || '生成系统提示词失败',
              showClose: true
            });
            return;
          }
          ...
          // 设置生成的系统提示词
          console.log('Setting systemPrompt to:', body.data);
          this.form.systemPrompt = body.data;
          console.log('After setting, form.systemPrompt:', this.form.systemPrompt);
        ...
        this.$message.error({
          message: '生成系统提示词失败: ' + error.message,
          showClose: true
        });
      }
    },
